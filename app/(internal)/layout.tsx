  ...
  return (
    <div className="app-shell min-h-dvh md:pl-52">
      <header className="sticky top-0 z-30 border-b border-white/6 bg-navy/95 backdrop-blur-md after:absolute after:inset-x-0 after:bottom-0 after:h-0.5 after:bg-gradient-to-r after:from-accent after:via-gold after:to-transparent">
        <div
          className="flex items-center gap-x-5 px-4 py-2 md:px-6 md:py-2.5"
          style={{ paddingTop: "max(0.5rem, env(safe-area-inset-top))" }}
        >
          <div className="flex min-w-0 shrink-0 items-center gap-2.5">
            <Image src="/logo-mark.png" alt="ECM logo" width={40} height={34} className="shrink-0" />
            <div className="font-display text-sm font-bold tracking-wide md:text-base">ECM</div>
          </div>
          <Link
            href="/account"
